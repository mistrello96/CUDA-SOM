/*
  ...
  gengetopt --input=lineparser.ggo --include-getopt 
...
const char *cmdline_parser_lactice_values[] = {"r", "e", 0}; /*< Possible values for lactice. */
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->lactice_arg = gengetopt_strdup ("r");
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:x:y:s:f:a:n:dvr:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'i':	/* PATH to the input file.  */
          ...
          break;
        case 'x':	/* allows to provide the number of rows in the neuron's matrix.  */
          ...
          break;
        case 'y':	/* allows to provide the number of columns in the neuron's matrix.  */
        ...
        case 'v':	/* enables debug print.  */
          ...
          break;
        case 'r':	/* allows to chose the initial radius of the updating function.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "lactice") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->lactice_arg), 
                 &(args_info->lactice_orig), &(args_info->lactice_given),
                &(local_args_info.lactice_given), optarg, cmdline_parser_lactice_values, "r", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "lactice", '-',
                additional_error))
              goto failure;
          ...
          /* enables the randomization of the dataset. Before presentig the dataset to the SOM, all entrys are shuffled..  */
